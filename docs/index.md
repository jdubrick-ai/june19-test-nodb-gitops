...
# Application
An application built from https://github.com/jdubrick-ai/june19-test-nodb will be stored in [quay.io/jdubrick-ai/june19-test-nodb](https://quay.io/jdubrick-ai/june19-test-nodb) and deployed through GitOps. This application is accessible on port **8501**.